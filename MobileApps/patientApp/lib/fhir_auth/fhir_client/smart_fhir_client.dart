...
class SmartFhirClient extends SecureFhirClient {
  ...
  @override
  Future<void> login({Function? callBackFunction,Function? callBackForTokenUrl}) async {
    if (!(await isLoggedIn())) {
      ...
      if(callBackForTokenUrl != null && tokenUrl != null){
        callBackForTokenUrl.call(tokenUrl.toString());
      }
      ...
      print("Auth---------------->"+authorizationUrl.toString());
      ...
      try {
        ...
        client = await grant. handleAuthorizationResponse(
            Uri.parse(returnValue).queryParameters,callBackFunction: callBackFunction);
        Debug.printLog("client..........${client}");
        ...
        if(callBackFunction != null){
          var map = {};
          map[Constant.fhirParameters] = {};
          map[Constant.isSuccess] = false;
          map[Constant.msg] = Constant.txtUserCanceled;
