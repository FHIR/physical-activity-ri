...
class AppFontStyle {
  ...
  static headerStyleWeb(BoxConstraints constraints) {
    return TextStyle(
      color: CColor.black,
  ...
  static double sizesFontManageWeb( double value ,BoxConstraints constraints){
    ...
    Debug.printLog("total FontSize.....${scaleFactor * value}");
  ...
  static double sizesHeightManageWeb( double value ,BoxConstraints constraints){
    ...
    Debug.printLog("total Height.....${scaleFactor * value}");
    return scaleFactor * value;
  ...
  static double sizesWidthManageWeb( double value ,BoxConstraints constraints){
    ...
    Debug.printLog("total Width.....${scaleFactor * value}");
