...
class MobileHealthProviderIntroScreen extends StatelessWidget {
  ...
  _widgetHealthProvider(
    ...
    return Column(
      children: [
        ...
        _widgetButtonSkip(logic,orientation),
      ],
    );
  }
        ...
        children: [
          Container(
            ...
            child: Text(
              ...
              style: AppFontStyle.styleW500(CColor.black, (orientation == Orientation.portrait)?  14.sp: 8.sp),
            ),
          ),
          Container(
            margin: EdgeInsets.only(
              top: (orientation == Orientation.portrait)? 9.h : 9.h,
            ),
            alignment: Alignment.centerLeft,
            child: Text(
  ...
  _widgetButtonYes(HealthProviderIntroController logic,Orientation orientation
    ...
    return Container(
      padding: EdgeInsets.only(
        top: (orientation == Orientation.portrait)?  5.h : 2.h, bottom: (orientation == Orientation.portrait)?  5.h : 2.h,),
      child: Row(
        children: [
          ...
          InkWell(
            ...
            child: Container(
              padding:  EdgeInsets.symmetric(
                  vertical: (orientation == Orientation.portrait)? 8.h:5.h,
                  horizontal:(orientation == Orientation.portrait)? 20.w : 18.w
              ),
              alignment: Alignment.center,
  ...
  _widgetButtonSkip(HealthProviderIntroController logic,Orientation orientation
    ...
    return Container(
      margin: EdgeInsets.only(
          bottom: (orientation == Orientation.portrait)? 10.h : 5.h
      ),
      child: Row(
        children: [
          Expanded(child: Container()),
