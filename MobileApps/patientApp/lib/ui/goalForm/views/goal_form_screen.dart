...
class GoalFormScreen extends StatelessWidget {
              ...
              child: GetBuilder<GoalFormController>(builder: (logic) {
                return Column(
                  children: [
                    ...
                    // _widgetDescEditText(logic,constraints),
                    // if(logic.selectedStatusFix.toLowerCase() != Constant.lifeCycleProposed.toLowerCase()) _widgetLifecycleStatusDropDown(context, logic,constraints),
                    if(logic.isEdited && logic.selectedLifeCycleStatus != Constant.lifeCycleProposed)_widgetLifecycleStatusDropDown(context, logic,constraints),
                    // if(logic.notesList.isNotEmpty || logic.dataEditable)
                    ...
                    if(logic.selectedStatusFix.toLowerCase() == Constant.lifeCycleProposed.toLowerCase()) _buttonSaveAsDraft(context),
                  ],
                );
              }),
            );
                      ...
                      return [
                        PopupMenuItem(
                          child: Container(
                              ...
                              child: const Text(
                                  "The type of physical activity goal that has been set.")),
                        ),
                      ];
                    },
            ...
            (logic.dataEditable)
                ? Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: CColor.greyF8,
                      border:
                          Border.all(color: CColor.primaryColor, width: 0.7),
                    ),
                    ...
                    children: [
                      Expanded(
                        child: Container(
                          padding: EdgeInsets.symmetric(
                              horizontal:
                                  (kIsWeb) ? Sizes.width_1_5 : Sizes.width_3,
                              vertical: Sizes.height_1_5),
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(15),
                            color: CColor.greyF8,
                            border: (logic.isEdited)?null:Border.all(
                                color: (logic.isEdited)?CColor.qrBGColor:CColor.primaryColor, width: 0.7),
                          ),
                          child: Text(
                            logic.selectedGoalMeasure!.goalValue.toString(),
                            overflow: TextOverflow.ellipsis,
                            style: AppFontStyle.styleW500(CColor.black,
                                (kIsWeb) ? AppFontStyle.sizesFontManageWeb(1.0, constraints)  : FontSize.size_10),
                          ),
  ...
  _widgetLifecycleStatusDropDown(
      BuildContext context, GoalFormController logic,BoxConstraints constraints) {
    return GetBuilder<GoalFormController>(builder: (logic) {
      return Container(
        margin: EdgeInsets.symmetric(horizontal: (kIsWeb) ? AppFontStyle.sizesWidthManageWeb(1.0, constraints): Sizes.width_3),
        child: Column(
                        ...
                        PopupMenuItem(
                          child: Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  borderRadius: BorderRadius.circular(10)),
                              child: const Text(
                                  "The current status of the goal. Options include 'Active' for ongoing goals, 'Completed' for achieved goals, and 'Cancelled' for goals that are no longer pursued")),
                        ),
                      ];
                    },
                    child: Icon(Icons.info_outline,
                    ...
                    children: [
                      Expanded(
                        child: Container(
                          ...
                          child: Text(
                            logic.selectedLifeCycleStatus.toString(),
                            style: AppFontStyle.styleW500(CColor.black,
  ...
  _widgetAchievementStatusDropDown(
      BuildContext context, GoalFormController logic,BoxConstraints constraints) {
    return GetBuilder<GoalFormController>(builder: (logic) {
      return Expanded(
        child: Container(
                      ...
                      children: [
                        Expanded(
                          child: Container(
                            ...
                            child: Text(
                              logic.selectedAchievementStatus.toString(),
                              style: AppFontStyle.styleW500(CColor.black,
                                  (kIsWeb) ? FontSize.size_3 : FontSize.size_10),
                            ),
                          ),
          ...
          child: Row(
            children: [
                          ...
                          PopupMenuItem(
                            child: Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    borderRadius: BorderRadius.circular(10)),
                                child: const Text(
                                    "Additional comments or details about the physical activity goal, including motivations, obstacles, or specific observations related to progress")),
                          ),
                        ];
                      },
                      child: Icon(Icons.info_outline,
              ...
              /*(logic.dataEditable)
                  ? InkWell(
                      onTap: () {
                        showDialogForAddNewCode(context, logic, false, 0);
                      },
                      child: Container(
                          margin: EdgeInsets.only(
                            right: Sizes.width_2,
  ...
  showDialogForAddNewCode(
      BuildContext context, GoalFormController logic, bool isEditNote, index) {
    showDialog(
      context: context,
                        ...
                        child: /*HtmlEditor(
                          ...
                          htmlToolbarOptions: const HtmlToolbarOptions(
                            ...
                            defaultToolbarButtons: [
                              ...
                              FontButtons(strikethrough: false,clearAll: false,subscript: false,superscript: false,italic: false,bold: false,underline: false),
                              // ColorButtons(),
                          ...
                          callbacks: Callbacks(
                            ...
                            onChangeCodeview: (String? changed) {
                              ...
                              logic.editNoteDataController(changed ?? "",false);
                            },
                          ),
                        )*/
                        Column(
  ...
  _itemNotes(int index, notesData, GoalFormController logic,
      BuildContext context,BoxConstraints constraints) {
        ...
        ? InkWell(
            onTap: () {
             /* if (logic.notesList[index].isCreatedNote ?? false) {
                ...
                showDialogForAddNewCode(context, logic, true, index);
              }*/
            },
            child: Column(
              children: [
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                          child: Container(
                            margin: EdgeInsets.only(left: (kIsWeb) ? AppFontStyle.sizesWidthManageWeb(0.8, constraints): Sizes.width_1),
                        alignment: Alignment.centerLeft,
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.start,
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            if(notesData.author.toString().toLowerCase() != "null" && notesData.author != "")
                            Container(
                      ...
                      ((logic.notesList[index].isCreatedNote ?? false) && Utils.getPrimaryServerData() != null)
                          ? Column(
                              children: [
                                InkWell(
                                  onTapUp: (details) {
                                ...
                                InkWell(
                                  onTap: () {
                                    logic.deleteNoteListData(
                                        notesData.noteId, index);
                                    Debug.printLog("Delete");
                                  },
                                  child: Container(
  ...
  Widget _widgetDescEditText(GoalFormController logic,BoxConstraints constraints) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        /*Container(
        ...
        Container(
          ...
          child: TextFormField(
            maxLines: 3,
            enabled: (logic.dataEditable) ? true : false,
        ...
        children: [
                      ...
                      PopupMenuItem(
                        child: Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                borderRadius: BorderRadius.circular(10)),
                            child: const Text(
                                "The target value for the goal, such as the number of days per week to be active.")),
                      ),
                    ];
                  },
                  child: Icon(Icons.info_outline,
          ...
          Container(
            margin: EdgeInsets.only(
                ...
                left:(kIsWeb) ? AppFontStyle.sizesWidthManageWeb(1.0, constraints): Sizes.width_3),
            decoration: BoxDecoration(
              border: (!logic.dataEditable)?null:Border.all(
                  color: CColor.primaryColor,
                  width: 0.7
              ),
              borderRadius: BorderRadius.circular((kIsWeb) ? AppFontStyle.sizesWidthManageWeb(0.8, constraints) :15),
                      ...
                      PopupMenuItem(
                        child: Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                borderRadius: BorderRadius.circular(10)),
                            child: const Text(
                                "The date by which the physical activity goal is intended to be achieved.")),
                      ),
                    ];
                  },
                  child: Icon(Icons.info_outline,
      ...
      child: GetBuilder<GoalFormController>(builder: (logic) {
        return Container(
          ...
          width: double.infinity,
            ...
            padding: (logic.selectedLifeCycleStatusHint != Constant.lifeCycleProposed) ? (logic.isEdited) ? EdgeInsets.all((kIsWeb) ? 10 : 2):EdgeInsets.all(0) : EdgeInsets.all(0),
          child: TextButton(
            onPressed: () {
              logic.insertForSign();
            ...
            child: Padding(
              padding: (logic.selectedLifeCycleStatusHint != Constant.lifeCycleProposed) ? (logic.isEdited) ?EdgeInsets.all((kIsWeb) ? 10 : 2) :EdgeInsets.all((kIsWeb) ? 10 : 5) :EdgeInsets.all((kIsWeb) ? 10 : 5),
              child: Text(
  ...
  Widget _buttonCancel(BuildContext context,GoalFormController logic) {
    return Expanded(
      child: Container(
        margin: EdgeInsets.only(
            top: Sizes.height_3, left: Sizes.width_2, right: Sizes.width_2),
  ...
  Future<void> showDatePickerDialog(
      GoalFormController logic, BuildContext context) async {
    await showDialog(
      context: context,
      barrierDismissible: true,
      builder: (context) {
        return AlertDialog(
          ...
          content: Container(
              ...
              child: SfDateRangePicker(
                ...
                showActionButtons: Utils.manageCalenderInNavigation(),
  ...
  Widget  _buttonSaveAsDraft(BuildContext context) {
    return GetBuilder<GoalFormController>(builder: (logic) {
      return Container(
        margin: EdgeInsets.only(
            bottom: Sizes.height_3, left: Sizes.width_2, right: Sizes.width_2),
        width: double.infinity,
        decoration: BoxDecoration(
          border: Border.all(
              color: (logic.selectedLifeCycleStatusHint != Constant.statusDraft && !logic.isEdited) ? CColor.transparent:CColor.primaryColor,
              width: (logic.selectedLifeCycleStatusHint != Constant.statusDraft && !logic.isEdited) ? 0:2
          ),
        ...
        padding: (logic.selectedLifeCycleStatusHint != Constant.statusDraft && !logic.isEdited) ? EdgeInsets.all(0) : EdgeInsets.all((kIsWeb) ? 10 : 5),
        child: TextButton(
          onPressed: () {
          ...
          child: Padding(
            padding: logic.selectedLifeCycleStatusHint == Constant.statusDraft ?EdgeInsets.all((kIsWeb) ? 10 : 5) : EdgeInsets.all((kIsWeb) ? 10 : 3),
            child: Text(
              "Save as draft",
              textAlign: TextAlign.center,
              style: AppFontStyle.styleW400(CColor.white,
