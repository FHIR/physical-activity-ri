...
class WebHistoryScreen extends StatelessWidget {
      ...
      child: Scaffold(
        ...
        body: LayoutBuilder(
          builder: (BuildContext context,BoxConstraints constraints) {
            // return Utils.pullToRefreshApi(_widgetWeb(constraints,logic,context),logic.refreshController,logic.onRefresh,logic.onLoading);
            return _widgetWeb(constraints,logic,context);
          }
        ),
      ),
    );
  ...
  _widgetWeb(BoxConstraints constraints ,HistoryController logic,BuildContext context){
    return Column(
    ...
    return Container(
      ...
      child: Container(
        ...
        child: PopupMenuButton<int>(
          ...
          offset: Offset(-Sizes.width_2, 50),
                    ...
                    Container(
                      ...
                      child: ListView.builder(
                        itemBuilder: (context, index) {
                          return Container(
                            margin: EdgeInsets.only(
                              top: Utils.sizesHeightManage(context, 1.0)
                            ),
                            child: Row(
                              children: [
                                Text(
          ...
          child: PopupMenuButton<int>(
            ...
            [
              PopupMenuItem(
                value: 1,
                child: Utils.getSmileyWidget(
                    Constant.smiley1ImgPath, Constant.smiley1Title,constraints: constraints,
                    isWeb: true),
              ),
              PopupMenuItem(
                value: 2,
                child: Utils.getSmileyWidget(
                    Constant.smiley2ImgPath, Constant.smiley2Title,constraints: constraints,
                    isWeb: true),
              ),
              PopupMenuItem(
                value: 3,
                child: Utils.getSmileyWidget(
                    Constant.smiley3ImgPath, Constant.smiley3Title,constraints: constraints,
                    isWeb: true),
              ),
              PopupMenuItem(
                value: 4,
                child: Utils.getSmileyWidget(
                    Constant.smiley4ImgPath, Constant.smiley4Title,constraints: constraints,
                    isWeb: true),
              ),
              PopupMenuItem(
                value: 5,
                child: Utils.getSmileyWidget(
                    Constant.smiley5ImgPath, Constant.smiley5Title,constraints: constraints,
                    isWeb: true),
              ),
              PopupMenuItem(
                value: 6,
                child: Utils.getSmileyWidget(
                    Constant.smiley6ImgPath, Constant.smiley6Title,constraints: constraints,
                    isWeb: true),
              ),
              PopupMenuItem(
                value: 7,
                child: Utils.getSmileyWidget(
                    Constant.smiley7ImgPath, Constant.smiley7Title,constraints: constraints,
                    isWeb: true),
              ),
            ],
                ...
                onSelected: (value) {
                  ...
                  selectDateWithActivityChoose(
                    ...
                    logic.onChangeActivityDateLocal(
                      ...
                      logic.localEndDate ?? DateTime.now(),constraints);
                },
                child: Container(
                    margin: EdgeInsets.only(left: AppFontStyle.sizesWidthManageWeb(1.2,constraints)),
                    child:  Text("+",
                      style: TextStyle( fontSize: AppFontStyle.commonFontSizeBodyWeb(constraints)),
                    )),
              )
                  ...
                  /*InkWell(
                    ...
                    child: Icon(
                      ...
                      color: (Constant.isEditMode)
                          ? CColor.red
                          : Colors.grey,
                      size: AppFontStyle.commonFontSizeBodyWeb(constraints)+2,
                    ),
                  ),*/
                  Expanded(
                    child: Container(
...
//   }
  ...
  Widget _widgetNumberImage(String type, String iconName,BuildContext context,BoxConstraints constraints) {
    return Row(
      children: [
        Image.asset(
        ...
        Container(
          ...
          child: Text(
            type,
            style: AppFontStyle.styleW400(CColor.black, AppFontStyle.commonFontSizeBodyWeb(constraints)
            ),
            overflow: TextOverflow.ellipsis,
          ),
        ),
...
*/
  ...
  Future<void> selectFromAndToDate(BuildContext context, DateTime startDate,
      ...
      int mainIndex, int daysIndex, int daysDataIndex, HistoryController logic,BoxConstraints constraints,
                            ...
                            data: CupertinoThemeData(
                              textTheme: CupertinoTextThemeData(
                                dateTimePickerTextStyle: TextStyle(
                                  ...
                                  // fontSize: Utils.sizesFontManage(context, 2.0),
                                ),
                              ),
                            ),
  ...
  Future<void> selectDateWithActivityChoose(BuildContext context,
      ...
      DateTime activityStartDate, DateTime activityEndDate,BoxConstraints constraints) async {
    await showDialog(
      context: context,
      builder: (BuildContext context) {
        return StatefulBuilder(
                                ...
                                child: GestureDetector(
                                  onTap: () {
                                    selectDateTimeWithActivityChoose(
                                        ...
                                        false,
                                        activityStartDate,
                                        activityEndDate, constraints,(dateTime) {
                                      setState(() {
  ...
  Future<void> selectDateTimeWithActivityChoose(BuildContext context,
      bool isEndDate, DateTime fromDate, DateTime toDate,BoxConstraints constraints,
      Function callBack) async {
    var tempDate = DateTime.now();
    await showCupertinoModalPopup(
      context: context,
