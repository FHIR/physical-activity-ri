...
Widget editableActivityCalories(int daysDataIndex, HistoryController logic,
                 ...
                 /* enabled: ( logic
                  ...
                  (Constant.isEditMode &&
                      Constant.configurationInfo
                          ...
                          .toList()
                          .isNotEmpty && !logic.caloriesDataList[mainIndex].daysList[daysIndex].daysDataList[daysDataIndex].isFromAppleHealth):true,
...
Widget editableActivitySteps(int daysDataIndex, HistoryController logic,
    int mainIndex, int daysIndex,String titleType, CaloriesStepHeartRateData daysDataList,BuildContext context,
    {Function? onChangeData}) {
  return SizedBox(
      height: 20,
                ...
                child: TextField(
                  ...
                  (Constant.isEditMode &&
                      Constant.configurationInfo
                          ...
                          .toList()
                          .isNotEmpty
                      && !logic.stepsDataList[mainIndex].daysList[daysIndex].daysDataList[daysDataIndex].isFromAppleHealth):true,*/
                  // enabled: false,
                  enabled: ( logic
                      .stepsDataList[mainIndex]
                      .daysList[daysIndex]
                  ...
                  (Constant.isEditMode &&
                      Constant.configurationInfo
                          ...
                          .toList()
                          .isNotEmpty && !logic.stepsDataList[mainIndex].daysList[daysIndex].daysDataList[daysDataIndex].isFromAppleHealth):true,
                  enableInteractiveSelection: false,
                  focusNode: daysDataList.daysDataValueFocus,
                  textInputAction: TextInputAction.done,
                  inputFormatters: [FilteringTextInputFormatter.digitsOnly],
