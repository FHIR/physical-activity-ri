...
mixin Api {
  ...
  static final fhirCallbackWeb = FhirUri('https://testphysicalactivity.com/redirect.html');


/*  static FhirUri get fhirCallbackWeb {
    String? hostname = window.location.hostname;
    if (hostname == 'localhost') {
      return FhirUri('http://localhost:5000/redirect.html');
    } else {
      return FhirUri('https://testphysicalactivity.com/redirect.html');
    }
  }*/
  /// HAPI Server
