...
class WebConfigurationScreen extends StatelessWidget {
        ...
        Container(
          ...
          child: Row(
            children: [
              Expanded(
                child: Container(
                  padding: EdgeInsets.only(top: 2.h, bottom: 2.h, left: 6.w),
                  child: Text("General",
                      style: AppFontStyle.styleW700(Colors.black, 8.sp)),
                ),
              ),
            ],
          ),
            ...
            child: Row(
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    title,
                    style: AppFontStyle.styleW400(CColor.black, 5.sp),
                  ),
                ),
  ...
  showDialogForAddNewCode(BuildContext context, ConfigurationController logic) {
    showDialog(
      context: context,
