...
//         // scrollPhysics: (isScroll)?const NeverScrollableScrollPhysics():const AlwaysScrollableScrollPhysics(),
...
//     return headerWidget(orientation,logic,context);
//   }
//
//   List<Widget>? headerWidget(Orientation orientation, HistoryController logic, BuildContext context){
//     List<Widget> header = [];
//     header.add(cWhatWhenWidgetNormal(orientation));
...
//   }
//
//   List<Widget>? rightSideWidget(Orientation orientation, HistoryController logic, BuildContext context){
//     List<Widget> header = [];
//     for (int i = 0; i < logic.trackingPrefList.length; i++) {
//       if(logic.trackingPrefList[i].titleName == Constant.configurationHeaderModerate){
//         header.add(_widgetActivityMinMod(orientation, logic, context,Constant.activityMinutesMod));
//       }
//       else if(logic.trackingPrefList[i].titleName == Constant.configurationHeaderVigorous){
//         header.add(_widgetActivityMinMod(orientation, logic, context,Constant.activityMinutesVig));
//       }
//       else if(logic.trackingPrefList[i].titleName == Constant.configurationHeaderTotal){
//         header.add(_widgetActivityMinMod(orientation, logic, context,Constant.activityMinutesTotal));
//       }
//       else if(logic.trackingPrefList[i].titleName == Constant.configurationNotes){
//         header.add(_widgetActivityMinMod(orientation, logic, context,Constant.noteType));
//       }
//       else if(logic.trackingPrefList[i].titleName == Constant.configurationHeaderDays){
//         header.add(_widgetDaysStrengthDataList(orientation, logic, context));
//       }
//       else if(logic.trackingPrefList[i].titleName == Constant.configurationHeaderCalories){
//         header.add(_widgetCaloriesDataList(orientation, logic, context));
//       }
//       else if(logic.trackingPrefList[i].titleName == Constant.configurationHeaderSteps){
//         header.add(_widgetStepsDataList(orientation, logic, context));
//       }
//       else if(logic.trackingPrefList[i].titleName == Constant.configurationHeaderRest){
//         header.add(_widgetHeartRateDataList(orientation, logic, context,Constant.heartRateRest));
//       }
//       else if(logic.trackingPrefList[i].titleName == Constant.configurationHeaderPeck){
//         header.add(_widgetHeartRateDataList(orientation, logic, context,Constant.heartRatePeak));
//       }
//       else if(logic.trackingPrefList[i].titleName == Constant.configurationExperience){
//         header.add(_widgetExperienceDataList(orientation, logic, context));
//       }
//     }
//     return header;
//   }
...
//   }
//
//   Widget _widgetActivityMinMod(Orientation orientation, HistoryController logic,BuildContext contex,String cType){
//     return Container(
...
//                 ((cType == Constant.activityMinutesMod)?Utils.getModRowColumnWidth(contex,logic):
//                 (cType == Constant.activityMinutesVig)?Utils.getVigRowColumnWidth(contex,logic):
//                 (cType == Constant.activityMinutesTotal)?Utils.getTotalRowColumnWidth(contex,logic):
//                 Utils.getNotesRowColumnWidth(contex,logic)),
//
...
//   }
//
//   Widget _widgetHeartRateDataList(Orientation orientation, HistoryController logic,BuildContext contex,String cType){
//     return Container(
//       decoration: const BoxDecoration(
//           border: Border(
//             right: BorderSide(
...
//         children: [
//           Container(
//             width: MediaQuery.of(contex).size.width * Utils.gePeaktHeartRateRowColumnWidth(contex,logic),
//             alignment: Alignment
//                 .topCenter,
//             child: ListView.builder(
//               itemBuilder:
...
//             // width:MediaQuery.of(contex).size.width * 0.15,
//             alignment: Alignment
//                 .topCenter,
//             child: ListView.builder(
//               itemBuilder:
...
//             return Container(
//               // margin: EdgeInsets.only(left: (orientation == Orientation.portrait)?Sizes.width_5:Sizes.width_5),
...
//                         children: [
//                           Image.asset(
//                             /*Utils.getNumberIconNameFromType(weekDaysDataList[daysIndex]
...
//       HistoryController logic,String cType) {
//     return Column(
...
//             crossAxisAlignment: CrossAxisAlignment.end,
//             children: [
//               if (Constant.boolActivityMinMod && cType == Constant.activityMinutesMod) Expanded(
//                 child: Container(
//                   padding: EdgeInsets.only(
//                       bottom: Sizes.height_1
//                   ),
//                   child: editableMod(onChangeData: (value) {}, mainIndex, logic,cType,logic.trackingPrefList),
//                 ),
//               ) else Container(),
//               const Text("  "),
//               if (Constant.boolActivityMinVig && cType == Constant.activityMinutesVig) Expanded(
//                 child: Container(
//                   padding: EdgeInsets.only(
//                       bottom: Sizes.height_1
//                   ),
//                   child: editableVig(onChangeData: (value) {
//                     Debug.printLog("Title 1 _editableTextValue2....$value");
//                     // logic.onChangeActivityMinVig(mainIndex, value);
//                   }, mainIndex, logic,cType,logic.trackingPrefList),
//                 ),
//               ) else Container(),
//               const Text("  "),
...
//       List<WeekDays> weekDaysDataList, HistoryController logic, int mainIndex, String cType) {
//     return (logic.activityMinDataList[mainIndex].weekDaysDataList[daysIndex].isShow)?
//     Column(
//       children: [
//         Column(
...
//                   ),
//                   const Text("  "),
//                   if (Constant.boolActivityMinMod && cType == Constant.activityMinutesVig) Expanded(
//                     child: Container(
//                       padding: EdgeInsets.only(
//                           bottom: Sizes.height_1
//                       ),
...
//                 mainAxisAlignment: MainAxisAlignment.end,
//                 children: [
//                   (Constant.boolActivityMinMod && cType == Constant.activityMinutesMod)?Expanded(
//                     child: Container(
//                       padding: EdgeInsets.only(
//                         bottom: Sizes.height_1,
//                       ),
//                       // child: _editableTextValue1DaysData(
...
//                   ):Container(),
//                   const Text("  "),
//                   (Constant.boolActivityMinVig && cType == Constant.activityMinutesVig)?Expanded(
//                     child: Container(
//                       padding: EdgeInsets.only(
//                         bottom: Sizes.height_1,
//                       ),
...
//                     bottom: Sizes.height_1,
//                   ),
//                   // child: _editableTextTitle2AndOtherDays(
//                   child: editableCalStepDay(
//                       daysIndex, logic, weekDaysDataList[daysIndex],
//                       onChangeData: (value) {
//                         // logic.onChangeCalStepDay(mainIndex, daysIndex, value,
//                         //     weekDaysDataList[daysIndex].titleName, titleType);
...
//                         .daysDataList[daysDataIndex],
//                     onChangeData: (value) {
//                       /*logic.onChangeCountOtherDaysData(mainIndex, daysIndex,
//                           daysDataIndex, value, titleType);*/
...
//               height: Constant.commonHeightForTableBoxMobile,
//               padding: EdgeInsets.only(
//                 // top: Sizes.height_1_8_2,
//                 right: Sizes.width_1_5,
//                 left: Sizes.width_1_5,
//                 // bottom: Sizes.height_0_55
//               ),
//               child: Row(
//                 crossAxisAlignment: CrossAxisAlignment.end,
//                 children: [
...
//       OtherTitles2CheckBoxWeek dataList, List<TrackingPref> trackingPrefList,
...
//       config: Utils.buildKeyboardActionsConfig(dataList.weekValueTitle2CheckBoxFocus),
//       child: SizedBox(
//         // width: 20,
//         height: 20,
//         child: TextField(
...
//                   bottom: Sizes.height_1,
//                 ),
//                 child: _editableDaysStrWeek(mainIndex, logic, dataList,logic.trackingPrefList,
//                     onChangeData: (value) {
...
//           /*  onChanged: (!Constant.isEditMode) ? null : (value) {
...
//             logic.activityMinDataList[mainIndex].weekDaysDataList[daysIndex].daysDataList[daysDataIndex].displayLabel &&
//             element.isDaysStr ).toList().isEmpty ) ? null : (value) {
...
//                           child: SingleChildScrollView(
//                             controller: logic.verticalController,
...
//                                     headingRowHeight: Sizes.height_6,
//                                     horizontalMargin: 0,
//                                     columnSpacing: 0,
//                                     columns: [
//                                       cWhatWhen(orientation),
//                                       cActivityMin(orientation,logic),
//                                       cDaysStr(orientation,logic),
//
//
//                                       if (logic.calories)
//                                         cCalories(orientation,logic),
//
//
//                                       if (logic.steps)
//                                         cSteps(orientation,logic),
//
//
//                                       if (logic.heartRate)
//                                         cHeartRate(orientation,logic),
//
//
//                                       if (logic.experience)
//                                         cExperience(orientation,logic),
//                                     ],
//                                     rows: [
//                                       DataRow(cells: [
//                                         DataCell(
...
//                                                   width: (orientation ==
//                                                       Orientation.portrait)
//                                                       ? (!logic.activityMinMod &&
//                                                       !logic.activityMinVig)
//                                                       ? Sizes.width_40
//                                                       : Sizes.width_50
//                                                       : Sizes.width_80,
//
