...
class GraphScreen extends StatelessWidget {
                ...
                builder: (BuildContext context,BoxConstraints constraints) {
                  return SafeArea(
                    child: Column(
                      children: [
                        (kIsWeb) ? Container(
                          margin: EdgeInsets.only(top: AppFontStyle.sizesHeightManageWeb(1.0, constraints)),
                          child: Row(
                            ...
                            children: [
                              ...
                              Expanded(child: _widgetMeasureDropDown(context,logic,constraints)),
                              Expanded(child: _widgetTimeDropDown(context,logic,constraints)),
                        ...
                        Expanded(
                          child: Container(
                            height: (kIsWeb) ? Sizes.height_60 : Sizes.height_50,
                            ...
                            child: SfCartesianChart(
                              ...
                              primaryXAxis: CategoryAxis(
                                labelStyle: TextStyle(
                                    fontSize: (kIsWeb) ? FontSize.size_4 : FontSize
                                        .size_8),
                              ),
                                      ...
                                      children: [
                                        Column(
                                          children: [
                                            ...
                                            Container(
                                              width: 50,
                                              child: const Divider(color: CColor.white),
                                            ),
                                            Container(
                                              child: Text(
                                                Utils.getSeriesDate(
                        ...
                        ) : Expanded(child: _emptyWidget(Constant.graphDataNotFind)),
  ...
  _widgetMeasureDropDown(BuildContext context,GraphController logic,BoxConstraints constraints) {
    return Container(
      ...
      // height: (kIsWeb) ? AppFontStyle.sizesHeightManageWeb(5.0, constraints) : null,
      margin: EdgeInsets.symmetric(
                ...
                children: [
                  Expanded(
                    child: Text(
                      ...
                      Constant.listOfMeaSure.isNotEmpty ?
                      Constant.listOfMeaSure[Constant.selectedRadioValue].titleName : "No Data",
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              child: (Constant.listOfMeaSure.isNotEmpty)
                  ? (Constant.listOfMeaSure[Constant.selectedRadioValue].titleName == Constant.experience)
                  ? Row(
                children: [
                  Container(
                    margin: EdgeInsets.symmetric(
        ...
        return StatefulBuilder(
          builder: (context, setStateGraph) {
            return AlertDialog(
                      ...
                      Container(
                        ...
                        child: ListView.builder(
                          itemBuilder: (context, mainIndex) {
                            return _itemMeasureData(logic, context,
                                Constant.listOfMeaSure[mainIndex], mainIndex,
              ...
              actions: [
                if(Constant.listOfMeaSure.isNotEmpty) Row(
                  ...
                  children: [
                    ...
                    TextButton(
                      onPressed: () {
                        /* var meaSureValue = "";
                              if(logic.listOfMeaSure.where((element) => element.isSelected).toList().isNotEmpty){
                                meaSureValue = logic.listOfMeaSure[logic.listOfMeaSure.indexWhere((element) => element.isSelected).toInt()].titleName;
                              }else {
                                var selectedSubListData = logic.listOfMeaSure
                                    .where((element) => element.subList
                                ...
                                var index = selectedSubListData[0].subList.indexWhere((element) => element.isSelected).toInt();
                                if(index != -1) {
                                  meaSureValue = selectedSubListData[0].subList[index].subTitleName;
                                }
                              }*/

                        if(Constant.listOfMeaSure.isNotEmpty){
                          // logic.getGraphDataAndSetTimeFrame(Constant.listOfMeaSure[Constant.selectedRadioValue].titleName);
                          if(Constant.listOfMeaSure[Constant.selectedRadioValue].titleName == Constant.experience){
                            logic.experienceManage(Constant.graphAMeaSureType);
                          }else{
                            logic.onChangeActivityTimeAndFrameGraphData(
  ...
  _itemMeasureData(GraphController logic, BuildContext context,
    ...
    return Column(
      children: [
        ...
        if (Constant.listOfMeaSure[mainIndex].subList.isNotEmpty) Container(
          margin: EdgeInsets.only(
          ...
          child: ListView.builder(
            itemBuilder: (context, index) {
              return Row(
                children: [
                  Checkbox(
                    value: Constant.listOfMeaSure[mainIndex].subList[index]
                        .isSelected,
  ...
  getGraphDetalis(GraphController logic,BoxConstraints constraints){
    return Container(
      ...
      margin: EdgeInsets.only(
          left: (kIsWeb ) ? Get.width * 0.11 :Sizes.width_15,top: Sizes.height_1
      ),
      child: (Constant.listOfMeaSure[Constant.selectedRadioValue].titleName== Constant.activityMinutes ) ?Column(
        mainAxisAlignment: MainAxisAlignment.end,
              ...
              Expanded(
                child: Row(
                  children: [
                    ...
                    Container(
                      width: (kIsWeb) ? AppFontStyle.sizesWidthManageWeb(1.1, constraints) : Sizes.width_3,
                      height: (kIsWeb) ? AppFontStyle.sizesWidthManageWeb(1.1, constraints) : Sizes.width_3,
                      color: CColor.txtBlue,
                    ),
                    Container(
                      margin: EdgeInsets.only(
                      ...
                      child: Text("Mod",style: TextStyle(fontSize:  (kIsWeb ) ? AppFontStyle.sizesFontManageWeb(1.1, constraints) : FontSize.size_13),),
                    )
                  ],
                ),
              ),
                ...
                child: Row(
                  children: [
                    ...
                    Container(
                      ...
                      child: Text("Vig",style: TextStyle(fontSize:(kIsWeb ) ?AppFontStyle.sizesFontManageWeb(1.1, constraints) : FontSize.size_13),),
                    )
                  ],
                ),
              ),
                ...
                child: Row(
                  children: [
                    ...
                    Container(
                      ...
                      child: Text("Total",style: TextStyle(fontSize:(kIsWeb ) ?AppFontStyle.sizesFontManageWeb(1.1, constraints) : FontSize.size_13),),
                    )
                  ],
                ),
              ),
                ...
                child: Row(
                  children: [
                    ...
                    Container(
                      ...
                      child: Text("Rest",style: TextStyle(fontSize:(kIsWeb ) ?AppFontStyle.sizesFontManageWeb(1.1, constraints) : FontSize.size_13),),
                    )
                  ],
                ),
              ),
                ...
                child: Row(
                  children: [
                    ...
                    Container(
                      ...
                      child: Text("Peak",style: TextStyle(fontSize:(kIsWeb ) ?AppFontStyle.sizesFontManageWeb(1.1, constraints) : FontSize.size_13),),
                    )
                  ],
                ),
              ),
