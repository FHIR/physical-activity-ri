                ...
                child: GetBuilder<ReferralFormController>(builder: (logic) {
                  return Column(
                    children: [
                      ...
                      if(logic.selectedStatus != Constant.statusDraft) _widgetStatusDropDown(context, logic,constraints),
                      ...
                      _buttonSaveAsDraft(context,constraints),
...
*/
  ...
  _widgetIntentDropDown(BuildContext context, ReferralFormController logic,BoxConstraints constraints) {
    return GetBuilder<ReferralFormController>(builder: (logic) {
      return Container(
                margin: EdgeInsets.symmetric(horizontal: (kIsWeb) ?AppFontStyle.sizesWidthManageWeb(1.0, constraints) : Sizes.width_3),
  ...
  _widgetReferralAssignedToDropDown(BuildContext context, ReferralFormController logic,BoxConstraints constraints) {
    return GetBuilder<ReferralFormController>(builder: (logic) {
      return Container(
                margin: EdgeInsets.symmetric(horizontal: (kIsWeb) ?AppFontStyle.sizesWidthManageWeb(1.0, constraints) : Sizes.width_3),
  ...
  _widgetPerformerDropDown(BuildContext context, ReferralFormController logic) {
    return GetBuilder<ReferralFormController>(builder: (logic) {
      return Container(
  ...
  _widgetOccurrence(BuildContext context, ReferralFormController logic) {
    return GetBuilder<ReferralFormController>(builder: (logic) {
      return Container(
        margin: EdgeInsets.symmetric(horizontal: Sizes.width_3),
        child: Column(
          ...
          children: [
            ...
            Container(
              width: double.infinity,
              padding: EdgeInsets.symmetric(
                  horizontal: (kIsWeb) ? Sizes.width_1_5 : Sizes.width_2,
...
*/
  ...
  Widget _widgetStartDate(ReferralFormController logic,BuildContext context,BoxConstraints constraints) {
    return Expanded(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
  ...
  Widget _widgetEndDate(ReferralFormController logic, BuildContext context,BoxConstraints constraints) {
    return Expanded(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
...
/*  _itemNotes(int index, NotesData notesData) {
  ...
  void showDialogForChooseCode(
      ReferralFormController logic, BuildContext context,BoxConstraints constraints) {
    showDialog(
      context: context,
      barrierDismissible: true,
      builder: (context) {
  ...
  showDialogForAddNewCode(BuildContext context, ReferralFormController logic, setStateDialogForChooseCode,BoxConstraints constraints){
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      //   color: CColor.transparent,
                      //   child: TextFormField(
                      //     controller: logic.addReferralCodeController,
                      //     focusNode: logic.addReferralCodeFocus,
                      //     textAlign: TextAlign.start,
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: TextButton(
                                onPressed: () {
                                  logic.addNewCodeDataIntoList(logic.addReferralTypeController.text,logic.addReferralCodeController.text);
  ...
  _itemCodeData(int index, BuildContext context, String codeList, ReferralFormController logic,BoxConstraints constraints) {
    return InkWell(
      onTap: () {
  ...
  _showDialogForAddNote(BuildContext context, ReferralFormController logic,bool isEditNote,index,BoxConstraints constraints){
    showDialog(context: context,
      barrierDismissible: true,
      builder: (context) {
        return AlertDialog(
  ...
  Widget _widgetEnterInstructions(ReferralFormController logic) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Container(
  ...
  showRestrictedToSelectionDialog(BuildContext context,ReferralFormController logic,BoxConstraints constraints){
    showDialog(
      context: context,
      barrierDismissible: true,
      builder: (context) {
  ...
  Widget _widgetSearchNameText(ReferralFormController logic,setStateFromMain,BoxConstraints constraints) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Container(
  ...
  _widgetPatientIds(ReferralFormController logic) {
    return Expanded(
      child: Container(
        margin: EdgeInsets.only(
  ...
  _itemPatientUser(int index, BuildContext context, PerformerData performerData,ReferralFormController logic) {
  ...
  _itemSelectedGoal(ConditionSyncDataModel goalData, int index, ReferralFormController logic,BoxConstraints constraints){
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
  ...
  _itemConditionListed(ConditionSyncDataModel goalData, ReferralFormController logic,
  ...
  Widget _widgetSearchCondition(ReferralFormController logic,setStateFromMain) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Container(
