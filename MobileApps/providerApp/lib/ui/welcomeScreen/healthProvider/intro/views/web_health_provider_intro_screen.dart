...
class WebHealthProviderIntroScreen extends StatelessWidget {
  ...
  WebHealthProviderIntroScreen(
      {required this.healthProviderController, Key? key})
      : super(key: key);
              ...
              return LayoutBuilder(
                ...
                return Column(
                  children: [
                    Expanded(
                        child:
                            _widgetHealthProvider(context, logic, constraints)),
  ...
  _widgetHealthProvider(BuildContext context,
      HealthProviderIntroController logic, BoxConstraints constraints) {
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Text(Constant.healthProviderIntro,
  ...
  _widgetButtonYes(HealthProviderIntroController logic, BuildContext context,
  ...
  _widgetButtonSkip(HealthProviderIntroController logic, BuildContext context) {
    return Container(
 ...
 /* _widgetImage(BoxConstraints constraints) {
    return Container(
      ...
      child: Image.asset(
        ...
        height: AppFontStyle.sizesFontManageWeb(12.0, constraints),
        width: AppFontStyle.sizesFontManageWeb(12.0, constraints),
        // width: 150.w,
      ),
    );
  }*/
