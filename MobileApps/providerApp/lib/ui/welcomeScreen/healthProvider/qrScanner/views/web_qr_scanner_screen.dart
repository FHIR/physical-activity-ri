...
class WebQrScannerScreen extends StatelessWidget {
            ...
            child: LayoutBuilder(
              builder: (BuildContext context,BoxConstraints constraints) {
                return GetBuilder<QrScannerController>(builder: (logic) {
                  return Column(
                    children: [
                      Expanded(child: _widgetQrManageDetails(context, logic,orientation,constraints),),
                      _widgetButtonDetails(context,constraints),
                    ],
                  );
                });
              }
  ...
  _widgetQrManageDetails(BuildContext context, QrScannerController logic,Orientation orientation,BoxConstraints constraints) {
    return Container(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            _widgetServerDropDown(context,logic,orientation,constraints),
...
/*  _widgetQrDetails(QrScannerController logic,BuildContext context) {
  ...
  _widgetMoreDetails(BuildContext context,BoxConstraints constraints) {
    return Container(
      ...
      alignment: Alignment.centerLeft,
      child: Text(
        "Please use the QR code or URL provided by your health provider to establish a connection with their system. Alternatively, you can enter the code manually.",
        textAlign: TextAlign.start,
  ...
  _widgetButtonDetails(BuildContext context,BoxConstraints constraints) {
    return GetBuilder<QrScannerController>(builder: (logic) {
      return Column(
  ...
  _widgetServerDropDown(BuildContext context, QrScannerController logic,Orientation orientation,BoxConstraints constraints) {
    return GetBuilder<QrScannerController>(builder: (logic) {
      return Container(
        ...
        child: Container(
          ...
          child: InkWell(
            onTap: (){
              Debug.printLog("is Single server...${Preference.shared.getBool(Preference.isSingleServer) ?? false}");
              if(Preference.shared.getBool(Preference.isSingleServer) ?? false){
                if(Utils.getServerList.isNotEmpty){
                  logic.changeIsAuth(Utils.getServerList[0].isSecure);
                  // Get.back();
                  showDialogForAddNewServerUrl(
                      context, logic, logic.update,true,orientation, constraints,index: 0);
                  logic.onChangeTextFiled(0,true);
                }else{
                  showDialogForAddNewServerUrl(
                      context, logic, logic.update, true, orientation,constraints,);
                ...
                if (Utils.getServerList.isEmpty) {
                  showDialogForAddNewServerUrl(
                      context, logic, logic.update, false,  orientation,constraints,);
                  logic.onChangeTextFiled(-1, false,);
                } else {
                  showDialogForChooseUrl(logic, context, orientation,constraints,);
                }
              }
              // showDialogForChooseUrl(logic, context);
            },
  ...
  void showDialogForChooseUrl(QrScannerController logic, BuildContext context,Orientation orientation,BoxConstraints constraints) {
    showDialog(
      context: context,
                    ...
                    children: [
                      ListView.builder(
                        itemBuilder: (context, index) {
                          return _itemUrlData(index, context,
                              Utils.getServerList[index].title, logic,setStateDialogForChooseCode,orientation,constraints,);
                        },
                      ...
                      InkWell(
                        onTap: () {
                          Get.back();
                          showDialogForAddNewServerUrl(
                              context, logic, setStateDialogForChooseCode,false,orientation,constraints,);
                          logic.onChangeTextFiled(-1,false);
                        },
                        child: Container(
                          margin: EdgeInsets.only(
  ...
  _itemUrlData(int index, BuildContext context, String codeList,
      QrScannerController logic,setStateDialogForChooseCode,Orientation orientation,BoxConstraints constraints) {
    return InkWell(
      onTap: () {
        setStateDialogForChooseCode(() {
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                ...
                Get.back();
                showDialogForAddNewServerUrl(
                    context, logic, setStateDialogForChooseCode,true,orientation,constraints,index: index);
  ...
  showDialogForAddNewServerUrl(BuildContext context, QrScannerController logic,
      setStateDialogForChooseCode,bool isEdit,Orientation orientation,BoxConstraints constraints ,{int index = -1}) {
    showDialog(
      context: context,
      barrierDismissible: true,
      builder: (context) {
