...
class MobileQrScannerScreen extends StatelessWidget {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            if((Preference.shared.getBool(Preference.isSingleServer) ?? false) && Utils.getServerList.isEmpty)
  ...
  _widgetServerDropDown(BuildContext context, QrScannerController logic,
      Orientation orientation) {
    return Container(
        height: (orientation == Orientation.portrait)? Get.height*0.15 :Get.height*0.12,
        margin: EdgeInsets.only(
            left:(orientation == Orientation.portrait) ? Sizes.width_3:Sizes.width_4, right:(orientation == Orientation.portrait)? Sizes.width_3 :Sizes.width_4, top: (orientation == Orientation.portrait)? Sizes.height_5:Sizes.height_2),
        child: Container(
                ...
                if(Preference.shared.getBool(Preference.isSingleServer) ?? false){
                  if(Utils.getServerList.isNotEmpty){
                    ...
                    showDialogForAddNewServerUrl(
                        context, logic, logic.update,true,orientation,index: 0);
                    logic.onChangeTextFiled(0,true);
                  }else{
                    showDialogForAddNewServerUrl(
                        context, logic, logic.update, true, orientation);
                  ...
                  if (Utils.getServerList.isEmpty) {
                    showDialogForAddNewServerUrl(
                        context, logic, logic.update, false, orientation);
                    logic.onChangeTextFiled(-1, false,);
                  } else {
    ...
    return Column(
      children: [
        Container(
          ...
          margin: EdgeInsets.only(top:(orientation == Orientation.portrait) ? 35.h : 0.h),
          child: ClipRRect(
            child: GestureDetector(
              ...
              child: SizedBox(
                ...
                height: (orientation == Orientation.portrait) ? 180.w :50.w,
              ...
              children: [
                Expanded(
                  child: InkWell(
                    ...
                    child: Container(
                      padding:  (orientation == Orientation.portrait) ?const EdgeInsets.all(10).w :EdgeInsets.symmetric(vertical: 4.5.w),
                      alignment: Alignment.center,
                      decoration: BoxDecoration(
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () {
                          Get.back();
                          showDialogForAddNewServerUrl(
                              context, logic, setStateDialogForChooseCode,false,orientation);
                          logic.onChangeTextFiled(-1,false,);
                        },
                        child: Container(
                          margin: EdgeInsets.only(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                ...
                Get.back();
                showDialogForAddNewServerUrl(
                    context, logic, setStateDialogForChooseCode,true,orientation,index: index);
  ...
  showDialogForAddNewServerUrl(BuildContext context, QrScannerController logic,
      setStateDialogForChooseCode,bool isEdit,Orientation orientation,{int index = -1}) {
    showDialog(
      context: context,
      barrierDismissible: true,
      builder: (context) {
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                            ...
                            Container(
                              ...
                              child: Column(
                                children: [
                                  Container(
                                    margin: EdgeInsets.only(
                                        right: Sizes.width_1, left: Sizes.width_2,bottom: Sizes.height_1),
                                    child: Row(
                          ...
                          Container(
                            margin: EdgeInsets.only(
                                right: Sizes.width_1, left: Sizes.width_2),
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text(
