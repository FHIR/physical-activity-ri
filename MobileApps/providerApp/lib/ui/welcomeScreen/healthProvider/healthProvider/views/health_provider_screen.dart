...
class HealthProviderScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Theme(
      ...
      child: GetBuilder<HealthProviderController>(builder: (logic) {
            ...
            return LayoutBuilder(
              ...
              return Scaffold(
                ...
                /* appBar: (logic.selectedIndex == 0)?null:AppBar(
                    title: Text( (logic.selectedIndex == 1) ?"Connect to Your Health Provider": "Select Patient Profile"),
                    backgroundColor: CColor.primaryColor,
                  ),*/
                body: _widgetPageView(logic, orientation, constraints),
              );
            });
          },
        );
  ...
  _widgetPageView(HealthProviderController logic, Orientation orientation,
        ...
        Expanded(
          child: PageView(
            ...
            children: [
              ...
              OrganizationProviderScreen(healthProviderController: logic),
        ...
        Container(
          margin: EdgeInsets.only(
              ...
              top: (kIsWeb)
                  ...
                  : (orientation == Orientation.portrait)
                      ? 20.h
                      : AppFontStyle.sizesHeightManageWeb(0.8, constraints)),
          child: Row(
