...
<@layout.registrationLayout displayMessage=!messagesPerField.existsError('username','password') displayInfo=realm.password && realm.registrationAllowed && !registrationDisabled??; section>
    ...
    <#elseif section = "form">
        <#if alreadyLoggedIn?? && alreadyLoggedIn>
            <p>${msg("alreadyLoggedIn")}</p>
        <#else>
            <div id="kc-form">
                            ...
                            <div class="input-icons">
                                ...
                                <div class="password-input-container">
                                    <div style="position: relative;">
                                        ...
                                        <i class="fa fa-eye-slash toggle-password " id="togglePasswordVisibility" aria-hidden="true" style="position: absolute; right: 5px; top: 50%; transform: translateY(-50%); cursor: pointer;"></i>
                                    </div>
                                </div>
