...
import ca.uhn.fhir.jpa.starter.interceptor.CustomServerInterceptor;
...
import ca.uhn.fhir.jpa.starter.util.*;
import ca.uhn.fhir.jpa.starter.util.auth.PatientAuthUtil;
import ca.uhn.fhir.jpa.starter.util.auth.PatientConfig;
...
//	@Bean(a)
//	public KeycloakUtil keycloakUtil(RestTemplate restTemplate) {
//		return new KeycloakUtil(restTemplate);
//	}
...
//	@Bean
//	public PatientAuthUtil patientAuthUtil(PatientConfig patientConfig, PatientUtil patientUtil, JwtUtil jwtUtil) {
//		return new PatientAuthUtil(patientUtil, jwtUtil);
//	}
...
//		FhirUtil fhirUtil,
//		JwtUtil jwtUtil,
//		PatientAuthUtil patientAuthUtil,
		CapabilityStatementCustomizer capabilityStatementCustomizer,
...
//		KeycloakUtil keycloakUtil
		...
		fhirServer.registerInterceptor(customServerInterceptor);
		fhirServer.registerInterceptor(capabilityStatementCustomizer);
